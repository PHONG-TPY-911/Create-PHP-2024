...
// $isCompanyLoggedIn = isset($_SESSION['company_login']);
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block">
                        <a href="List_user_apporve.php">
                            <?php
                            $stmt = $conn->query("SELECT count(*) FROM post_work_company WHERE InfoFull ='full'")->fetchColumn();
                            ?>
                            <button type="button" class="btn header-item noti-icon" title="ລາຍການແຈ້ງເຕືອນຫ" id="page-header-notifications-dropdown">
                                <i class="icon-sm" data-feather="bell"></i>
                                <span class="noti-dot bg-danger rounded-pill"><?= $stmt ?></span>
                            </button>
                        </a>
                    </div>
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li class="menu-title fw-bold" data-key="t-applications" style="color: black; font-size: 11px;">
                            ລາຍການເມນູຫຼັກ</li>
                        <!-- <li>
                            <a href="Table_emplyee.php">
                                <i class="bx bx-calendar icon nav-icon"></i>
                                <span class="menu-item" data-key="t-calendar">ຕາຕະລາງຜູ້ໃຊ້ງານ(ພະນັກງານ)</span>
                            </a>
                            </li> -->
                        <?php
                        // style="display: <?php echo $_SESSION['employee_login'] ? 'none' : 'block'; "
                        ...
                        <?php
                         ...
                         ?>
                        <li>
                            <a href="Table_Post_Work.php">
                                <i class="bx bx-calendar icon nav-icon"></i>
                                <span class="menu-item" data-key="t-calendar">ຕາຕະລາງ ປະກາດວຽກ(ບໍລິສັດ)</span>
                            </a>
                        </li>
                    </ul>
                </div>
                                ...
                                <div class="col-lg-3 col-md-5">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            $total_customers = $conn->query("SELECT count(*) FROM employees")->fetchColumn();
                                            // $user_customers = $conn->query("SELECT count(*) FROM employees WHERE Status='user'")->fetchColumn();
                                            ...
                                            <p class="text-muted mt-4 mb-0">ຈຳນວນຜູ້ໃຊ້ງານ(ຊອກວຽກ)</p>
                                            <h4 class="mt-1 mb-0">
                                                <?php echo $total_customers ? $total_customers : 0 ?>
