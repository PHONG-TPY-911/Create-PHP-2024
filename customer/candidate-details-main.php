              ...
              <div class="team-details-wrap">
                <div class="team-details-info">
                  ...
                  <div class="content">
                    ...
                    <button onclick="window.location.href = 'candidate-details-skill-add.html';" type="button"
                      class="btn-theme">ກ່ຽວກັບຂ້ອຍ</button>
                    <button onclick="window.location.href = 'candidate-details-add.html';" type="button"
                ...
                <div class="widget-item widget-contact">
                  <div class="widget-contact-form">
                    <div class="content">
                      ...
                      <p class="desc">KANYA ໃຫ້ບໍລິການ ອອກແບບແບຣນ ແລະ ສື່ໂຄສະນາ ສະຕູດີໂອຖືກກໍ່ຕັ້ງໃນປີ 2012
                        ໂດຍສະຖາປະນິກຈົບໃຫມ່ຄົນຫນຶ່ງ </p>
                      <p class="desc">ດ້ວຍຄວາມ ຕັ້ງໃຈຢາກຈະເຫັນສິ່ງໃຫມ່ໆ ໃນວຽກງານວົງການ creative ມີຄວາມເຊື່ອຫມັ້ນວ່າ
                        ການສື່ສານທີ່ມີປະສິດທິພາບ ຈະຊ່ວຍໃຫ້ທຸລະກິດ ຢູ່ໄດ້ແບບຍືນຍົງ ແລະ ໄດ້ໃຈຄົນລາວເປັນ ແນ່ນອນ</p>
                    </div>
                    <div class="content-list-wrap">
                      <div class="content mb--0">
                        <h4 class="title">ພື້ນຖານຄອມພິວເຕີ</h4>
                        <ul class="team-details-list mb--0">
                          <li><i class="icofont-check"></i> Micosoft Word</li>
                          <li><i class="icofont-check"></i> Micosoft Exel</li>
                          <li><i class="icofont-check"></i> Micosoft PowerPoint</li>
                          <li><i class="icofont-check"></i> OBS</li>
                      ...
                      <div class="content mb--0">
                        ...
                        <ul class="team-details-list mb--0">
                          <li><i class="icofont-check"></i> ລາວ</li>
                          <li><i class="icofont-check"></i> ອັງກິດ</li>
                          <li><i class="icofont-check"></i> ຈີນ</li>
                          <li><i class="icofont-check"></i> ຍີ່ປຸ່ນ</li>
                        </ul>
                      </div>
                    </div>
