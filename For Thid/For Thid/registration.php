                    ...
                    <div class="tab-pane fade show active" id="candidate" role="tabpanel" aria-labelledby="candidate-tab">
                      <form action="Register_customer.php" method="post">
                        ...
                        <div class="row">
                          ...
                          <div class="col-12">
                            <div class="form-group">
                              <input class="form-control" type="password" name="C_password" placeholder="ຢືນຢັນລະຫັດ">
                            </div>
                          </div>
                          <div class="col-12">
                            <div class="form-group">
                              <!-- <button type="button" name="register" class="btn-theme">ລົງທະບຽນ</button> -->
                              <button type="button1" name="register" class="btn-theme">ລົງທະບຽນ</button>
                            </div>
                          </div>
                        </div>
                      </form>
                    ...
                    <div class="tab-pane fade" id="employer" role="tabpanel" aria-labelledby="employer-tab">
                      <form action="#">
                        <div class="row">
                          <div class="col-12">
                            <div class="form-group">
                              <input class="form-control" type="name" placeholder="ຊື່">
                            </div>
                          </div>
                          <div class="col-12">
                            <div class="form-group">
                              <input class="form-control" type="lname" placeholder="ນາມສະກຸນ">
                            </div>
                          </div>
                          <div class="col-12">
                            <div class="form-group">
                              <input class="form-control" type="email" placeholder="ອີເມວ">
                            </div>
                          </div>
                          <div class="col-12">
                            <div class="form-group">
                              <input class="form-control" type="password" placeholder="ລະຫັດ">
                            </div>
                          </div>
                          <div class="col-12">
                            <div class="form-group">
                              <input class="form-control" type="password" placeholder="ຢືນຢັນລະຫັດ">
                            </div>
                          </div>
                          <div class="col-12">
                            <div class="form-group">
                              <button type="button" class="btn-theme">ລົງທະບຽນ</button>
                            </div>
                          </div>
                        </div>
                      </form>
